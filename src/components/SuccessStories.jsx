  ...
  const stories = [
    {
      ...
      quote:
        "I am so grateful to Coding Ninjas. Their lessons helped me excel in projects. CN transformed my journey, giving me clarity and optimization skills!",
    },
    {
      name: "Onkar Lapate",
      title: "SDF-1",
  ...
  return (
    <div className="bg-black text-white flex flex-col justify-center items-center gap-6 mt-4 p-5">
      ...
      <div className="flex gap-3 mb-2 overflow-x-auto">
        <p className="font-mulish flex-shrink-0 flex justify-center items-center text-[12px] px-2 py-1 bg-[#745e39] text-lightBg rounded-full font-bold my-2">
          Non tech to tech
        </p>
        <p className="font-mulish flex-shrink-0 flex justify-center items-center text-[12px] px-3 py-2 bg-[#745e39] text-white  rounded-full font-bold my-2">
          Service to product
        </p>
        <p className="font-mulish flex-shrink-0 flex justify-center items-center text-[12px] px-3 py-2 bg-[#745e39] text-white  rounded-full font-bold my-2">
          Tier 2/3 colleges
      ...
      <div className="w-full overflow-x-auto">
        <div className="flex gap-6  flex-nowrap justify-center items-center">
          {stories.map((story, index) => (
            <div
              key={index}
              className="bg-grey text-white rounded-lg p-6 max-w-xs w-72 h-96 flex-shrink-0 flex flex-col justify-center items-center shadow-md"
            >
              <img
                src={story.image}
                alt={story.name}
              ...
              />
              <h3 className="text-lg font-semibold mb-2 font-mulish text-center">
                {story.name}
              </h3>
              <p className="text-sm font-mulish text-center">{story.title}</p>
              <p className="text-sm mt-4 font-mulish text-center">
                {story.quote}
              </p>
